...
##获取系统财务数据
def readbase(market =0,code='000776'):
    global Cw
    global Code,Market,Setcode,Name,Py
    global Mindiff,Tqflag,Useddatanum,Multiplier
    global Totalcapital,Capital,Type2
    ...
    Code=code
    Market=market
    Cw= htdx.tdxapi.get_finance_info(market, code)
    Totalcapital=Cw['zongguben']
    Capital=int(Cw['liutongguben']/100)
    return Cw

#获取基本信息
def readbase2(market = 0,codex='000776'):
    global Mindiff,Tqflag,Useddatanum,Multiplier
...
##获取财务信息
def get_base(nMarket = 0,code='000776'):
    global Cw,Base2
    Cw=readbase(nMarket,code)
    Base2=readbase2(nMarket,code)
    return
